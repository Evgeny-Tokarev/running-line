...
var _animeEs = require("animejs/lib/anime.es.js");
  ...
  _createClass(RunningLine, [{
    ...
    value: function init(selector) {
      ...
      window.addEventListener("resize", function () {
        ...
        resizeTimer = setTimeout(function () {
          clearTimeout(resizeTimer);
          resizeTimer = setTimeout(function () {
            arget.removeEventListener("mouseover", this.stopAllAnimations.bind(this));
    ...
    value: function animate(target) {
      var _getWidthAndDuration = this.getWidthAndDuration(),
          ...
          duration = _getWidthAndDuration.duration;

      width = !this.rightDirection ? width : -width;
      this.animations[this.current] = (0, _animeEs2.default)({
        targets: target,
        easing: "linear",
        loop: 0,
